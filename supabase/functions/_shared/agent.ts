...
- "name" + masterName/labName есть → AI картинка ДОЛЖНА БЫТЬ БЕЗ ТЕКСТА. Имя мастера наложит фронт через canvas-оверлей выбранным шрифтом (image-модели рендерят шрифты криво). Включи в промт: "Keep the <placement> corner clean and uncluttered — leave space for a small signature to be composited in post-processing. Do NOT render any text, letters, names, or signatures in the image yourself."
- "logo" → AI картинка тоже БЕЗ ЛОГА. Логотип наложит фронт через canvas (image 2 как референс будет, но финальную позицию контролируем мы). Включи в промт: "Keep the <placement> corner clean and uncluttered — leave space for a logo to be composited in post-processing. Do NOT render the logo or any text in the image yourself."
