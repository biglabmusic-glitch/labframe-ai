...
export function BrandedResult({ src, brand, branding, styleId, onReady }: Props) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Логотип на канвасе больше не рисуем: его накладывает сервер в
      // process-job, до сохранения. Раньше брендирование жило только здесь, и
      // фотография из чата — которую как раз и сохраняют — уходила без него.
      // Рисовать поверх второй раз означало бы два логотипа в кадре.
